...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("AnieXEricaMusic/assets/font.ttf", 32)
        regular_font = ImageFont.truetype("AnieXEricaMusic/assets/font2.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "AnieXEricaMusic/assets/play_icons.png"
    ...
    # Add "ARISHF BOT" top-right (default font)
    font = ImageFont.truetype("AnieXEricaMusic/assets/font.ttf", 28)  # 
    text = "PURVI BOTS    "
